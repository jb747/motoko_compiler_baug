...
module {
  ...
  func eqStatus(x : Status, y : Status) : Bool {
    x.failed == y.failed and x.passed == y.passed and x.pending
    == y.pending and x.skipped == y.skipped;
  };
  ...
  func printStatus(status : Status) : Text {
    "Failed: " # Int.toText(status.failed) # ", Passed: "
    # Int.toText(status.passed) # ", Pending: " # Int.toText(status.pending)
    # ", Skipped: " # Int.toText(status.skipped);
  };
